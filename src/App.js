...
function App() {
  ...
  const reset = () => {
    ...
    setEyes(defaultValue.eyes);
    setEyebrow(defaultValue.eyebrows);
    setHair(defaultValue.hair);
    setMouth(defaultValue.mouth);
    setGlasses(defaultValue.glasses);
    setHats(defaultValue.hats);
    setEarrings(defaultValue.earrings);
    setNeckwear(defaultValue.neckwear);
    setClothing1(defaultValue.clothing1);
    setClothing2(defaultValue.clothing2);
    setClothing3(defaultValue.clothing3);
  };
  const handleReset = () => {
    reset();
  };
